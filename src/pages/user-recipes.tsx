...
export default function UserRecipes(recipes) {
  ...
  return (
    <div>
      ...
      <main className="container mx-auto mt-4 px-4 object-fill dark:bg-slate-500 max-w-full dark:text-white bg-gray-50 order-2">
        <div>
          <table className="bg-white dark:bg-slate-500 mx-auto mt-11 p-5 rounded-lg shadow-md">
            <thead>
              <tr className="text-s border-b-2 font-semibold dark:bg-slate-800 dark:text-white text-gray-700 border-gray-200 bg-gray-100 rounded-tl-lg rounded-tr-lg">
            ...
            <tbody>
              {recipeState.filter((r) => r.author_id == session?.user?.name).map((r, i) => (
                <tr
                ...
                >
                  <td className="p-5 text-blue dark:text-white">
                  ...
                  <td className="p-3"> {r.author_id}</td>
                  ...
                  {session && (
                    <td className="text-xs">
                      ...
                      <TrashIcon
                        ...
                        className="ml-6 mr-3 mt-3 cursor-pointer"
                        width={20}
                        height={20}
